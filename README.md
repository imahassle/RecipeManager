...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create RecipeManager-6025
  fly apps create RecipeManager-6025-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app RecipeManager-6025
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app RecipeManager-6025-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'RecipeManager-6025-staging' does not match app name in config file 'RecipeManager-6025'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name RecipeManager-6025-db
  fly postgres attach --app RecipeManager-6025 RecipeManager-6025-db

  fly postgres create --name RecipeManager-6025-staging-db
  fly postgres attach --app RecipeManager-6025-staging RecipeManager-6025-staging-db
  ```
